...
export async function POST(request: Request) {
  try {
    ...
    const systemPrompt = buildITAssessmentDocPrompt();
    ...
    console.error("IT assessment generate error:", error);
    return Response.json({ error: "Failed to generate IT assessment documents" }, { status: 500 });
  }
}
